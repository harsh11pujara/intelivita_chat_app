    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            StreamBuilder(
              stream: FirebaseDatabase.instance.ref("ChatRoom/${widget.chatRoom.chatRoomId}/messages").onValue,
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(contentPadding: const EdgeInsets.only(bottom: 8, top: 8, left: 16),hintText: "Type Here..",border: OutlineInputBorder(borderRadius: BorderRadius.circular(8))),
                    ),
                  ),
                  const SizedBox(
                    width: 5,
                    ...
                    onPressed: () async {
                      ...
                      if (messageController.text.trim().isNotEmpty) {
                        ...
                        try {
                          ...
                          if(ref.key != null) {
                            await ref.update({msgId: message.toMap()});
                          } else {
                            await ref.set({msgId: message.toMap()});
                          }
